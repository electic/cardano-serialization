...
export function metadatahash_to_bech32(a: number, b: number, c: number, d: number): void;
export function metadatahash_from_bech32(a: number, b: number): number;
...
export function transactionmetadata_general(a: number): number;
export function transactionmetadata_native_scripts(a: number): number;
export function transactionmetadata_set_native_scripts(a: number, b: number): void;
export function transactionmetadata_new(a: number): number;
